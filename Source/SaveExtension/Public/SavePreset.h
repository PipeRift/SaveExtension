...
public:
	...
	/* Defines what actor classes will be considered for saving */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Serialization")
	FActorClassFilter ActorFilter;

	UPROPERTY(EditAnywhere, meta = (InlineEditConditionToggle))
	bool bOverrideLoadActorFilter;

	/* Defines what actor classes will be considered for loading */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Serialization", meta = (EditCondition = bOverrideLoadActorFilter))
	...
	/* Defines what component classes will be considered for saving */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Serialization")
	FComponentClassFilter ComponentFilter;

	UPROPERTY(EditAnywhere, meta = (InlineEditConditionToggle))
	bool bOverrideLoadComponentFilter;

	/* Defines what component classes will be considered for saving */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Serialization", meta = (EditCondition = bOverrideLoadComponentFilter))
...
public:
	...
	FORCEINLINE const FActorClassFilter& GetSaveActorFilter() const { return ActorFilter; }
	FORCEINLINE const FComponentClassFilter& GetSaveComponentFilter() const { return ComponentFilter; }

	FORCEINLINE const FActorClassFilter& GetLoadActorFilter() const
	{
		return bOverrideLoadActorFilter ? LoadActorFilter : ActorFilter;
	}

	FORCEINLINE const FComponentClassFilter& GetLoadComponentFilter() const
	{
		return bOverrideLoadComponentFilter ? LoadComponentFilter : ComponentFilter;
	}
};
